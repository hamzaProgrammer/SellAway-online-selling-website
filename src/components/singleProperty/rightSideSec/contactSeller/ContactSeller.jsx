                            ...
                            <>
                                <Row>
                                    <Col xs={4} sm={4} md={4} lg={4} xl={4}>
                                        {
                                            realtedData?.ProfileImage  ? (
                                                <img alt="user avatar" style={{maxWidth : '50px' , maxHeight : '50px'}} src={realtedData?.ProfileImage} />
                                            ) : (
                                    ...
                                    <Col xs={3} sm={6} md={6} lg={6} xl={6}>
                                        <Button type="link" onClick={() => handleClick(realtedData?.Id)} style={{color : '#0097e6' , fontWeight : 600 }} >View Profile</Button>
                                    </Col>
                                </Row>
                                <Row>
