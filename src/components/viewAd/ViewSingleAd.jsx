...
import { Row, Col , Typography , Input , Select , Divider ,  Image  , Button , notification , Alert , Tag , Modal  } from 'antd';
import './ViewAd.css'
        ...
        <Row>
            <Col xs={{span :22 , offset : 1}} sm={{span :22 , offset : 1}} md={{span :22 , offset : 1}} lg={{span :22 , offset : 1}} >
                <div className="newAddPropertyMainDiv" >
                    ...
                    <Divider style={{marginTop : '20px' , marginBottom : '0px' , backgroundColor : '#95a5a6'}} />
                    <Typography className="propDetNewAddProperty" >View Uploaded  Images</Typography>
                    <Row style={{marginTop : '15px'}} >
                        ...
                        <Col xs={24} sm={12} md={8} lg={8} style={{display : 'flex' , justifyContent : 'center' , alignItems : 'center' , flexDirection : 'column'}} >
                            <Image
                                ...
                                src="https://images.unsplash.com/photo-1600585152220-90363fe7e115?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8aG9tZXN8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"
                                onClick={() => setVisible(true)}
                            />
                            <div style={{ display: 'none' }}>
                                <Image.PreviewGroup preview={{ visible, onVisibleChange: vis => setVisible(vis) }}>
                                    <Image src="https://images.unsplash.com/photo-1600585152220-90363fe7e115?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8aG9tZXN8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" />
                                    <Image src="https://images.unsplash.com/photo-1600585152220-90363fe7e115?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8aG9tZXN8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" />
                                    <Image src="https://images.unsplash.com/photo-1600585152220-90363fe7e115?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8aG9tZXN8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" />
                                </Image.PreviewGroup>
                            </div>
